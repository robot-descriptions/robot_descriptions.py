...
URDF_PATH: str = _path.join(PATH, "robots", "ur5_robot.urdf")

GRIPPER_URDF_PATH: str = _path.join(PATH, "robots", "ur5_gripper.urdf")

JOINT_LIMITED_URDF_PATH: str = _path.join(
    PATH, "robots", "ur5_joint_limited_robot.urdf"
)
